...
public class Testing {
    ...
    public static List<String> elementFirstToUppercase(
            List<String> words) {
    ...
    public static Set<String> forEachLoggingFailure(Album album) {
        ...
        album.getMusicians()
                ...
                .forEach(nationality -> System.out
                        .println("Found: " + nationality));
    ...
    public static Set<String> nationalityReportUsingPeek(Album album) {
        ...
        Set<String> nationalities = album.getMusicians()
                .filter(artist -> artist.getName().startsWith("The"))
                .map(artist -> artist.getNationality())
                .peek(nation -> System.out
                        .println("Found nationality:" + nation))
                .collect(Collectors.<String> toSet());
